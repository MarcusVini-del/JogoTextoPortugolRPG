programa
{
	...
	funcao inicio()
	{
		...
		{
			caso 0: 
				EscreverLento("Narrador: Indo ao laboratório\n", velocidadeMedia)
			...
			caso 1: 
				EscreverLento("????: Você não tem escolha, vá!", velocidadeLenta)
				limpa()
				pare
			
			caso contrario: 
				EscreverLento("????: Você não tem escolha, VÁ LOGO!", velocidadeLenta)
				limpa()
		} //fim da escolha ir ao lab
		...
		se(roleminEscolhido == "Azelf" ou roleminEscolhido == "azelf" ou roleminEscolhido == "AZELF")
		{
			...
			escolha(escolher)
			{
				...
				caso 0:
					...
					pare // fim da escolha ir de aviao
				...
				caso 1:
					...
					escreva("            ██████████████████████████░                ██████████████████████████▒              \n")
	          		...
	          		escolha(escolher)
	          		{
						...
						caso 0: 
							EscreverLento("Narrador: Ao começar a remexer no buggy, você pega a tocha e o isqueiro, acendendo a tocha e mirando nas plantas que se aproximavam de você, fazendo com que elas se queimassem com o fogo.\n", velocidadeRapida)
							pare
						
						caso 1: 
							EscreverLento("Narrador: Ao começar a remexer no buggy, você pega o borrífero(borrifador + sonífero), jogando  o sonífero nelas, fazendo com que elas adormecessem.\n", velocidadeRapida)
							pare
						...
						caso contrario: 
							...
							pare
					} //fim da escolha do trasnporte

					pare
			} //fim da escolha ir de aviao
			...
			enquanto(vidaAzelf > 0 e vidaMesprit > 0)
			{
				...
				} //fim da escolher acao 0

				//CODIGO ALTERADO PELO PROF PPARA PENSAR
				senao se(escolheracao == 1)
				{
	...
	} //enquanto batalha estiver acontecendo

		// a chave abaixo indoco fim do nome escolhido "Azelf"
 ...
 * 
 * @POSICAO-CURSOR = 20195; 
 * @DOBRAMENTO-CODIGO = [428, 322, 475, 507, 289, 866, 860, 880, 876, 890, 886, 896, 902];
 * @PONTOS-DE-PARADA = ;
